...
const ArticleItem = props => {
  const { article } = props;
  return (
    <List.Item style={{ padding: 30, background: 'white', boxShadow: '5px 5px 10px rgba(0, 0, 0, 0.3)', borderRadius :10, margin: 20 }}>
      <Grid>
        <Grid.Column width={5}>
          <Image src={article.urlToImage} style={{borderRadius :10}}/>
        </Grid.Column>
        <Grid.Column
          width={11}
          style={{
